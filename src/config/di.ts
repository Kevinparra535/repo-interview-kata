...
container.bind<GetAllTasksUseCase>(TYPES.GetAllTasksUseCase).to(GetAllTasksUseCase).inTransientScope();
container.bind<GetTaskByIdUseCase>(TYPES.GetTaskByIdUseCase).to(GetTaskByIdUseCase).inTransientScope();
container.bind<ObserveTasksUseCase>(TYPES.ObserveTasksUseCase).to(ObserveTasksUseCase).inTransientScope();
container.bind<SyncTasksUseCase>(TYPES.SyncTasksUseCase).to(SyncTasksUseCase).inTransientScope();
container.bind<ToggleTaskCompletedUseCase>(TYPES.ToggleTaskCompletedUseCase).to(ToggleTaskCompletedUseCase).inTransientScope();
container.bind<UpdateTaskAttachmentUseCase>(TYPES.UpdateTaskAttachmentUseCase).to(UpdateTaskAttachmentUseCase).inTransientScope();
container.bind<HomeViewModel>(TYPES.HomeViewModel).to(HomeViewModel).inTransientScope();
container.bind<TaskDetailViewModel>(TYPES.TaskDetailViewModel).to(TaskDetailViewModel).inTransientScope();
container.bind<CameraPermissionsViewModel>(TYPES.CameraPermissionsViewModel).to(CameraPermissionsViewModel).inTransientScope();
