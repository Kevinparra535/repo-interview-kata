...
module.exports = {
  ...
  ignorePatterns: ['/dist/*', 'functions/**', '/.expo', 'node_modules', 'functions/', 'functions/src'],
    ...
    'simple-import-sort/imports': [
      'error',
      {
        groups: [
          ...
          ['^images/', '^@/images/', '^\\.(png|jpe?g|gif|svg)$', '^@/images/.*\\.(png|jpe?g|gif|svg)$'],
          ['^styles/', '^@/styles/'],
          ['^stores/', '^@/stores/', '^\\./stores/', '^\\.\\./stores/'],
          ['^config/', '^@/config', '^@/ui/config', '^types/', '^@/types/', '^@/ui/types/', '^constants/', '^@/constants/', '^@/ui/constants/'],
        ],
      },
    ],
  },
        ...
        'simple-import-sort/imports': [
          'error',
          {
            groups: [
              ...
              ['^hooks/', '^@/hooks/'],
              ['^@/ui/i18n', '^components/', '^@/components/', '^@/ui/components/', '^\\./components'],
              [
                '^\\.(png|jpe?g|gif|svg)$',
                '^@/images/.*\\.(png|jpe?g|gif|svg)$',
                '^../assets/images/',
